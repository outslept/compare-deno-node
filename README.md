...
Updated Sep 14, 2026 • Node.js v26.8.2 • deno 2.9.6+[336da42](https://github.com/denoland/deno/commit/336da42) (canary, release, x86_64-unknown-linux-gnu)
...
[Object: null prototype] {
    ...
    deepEqual: <ref *4> ƒ deepEqual(length: 2) {},
    deepStrictEqual: <ref *5> ƒ deepStrictEqual(length: 2) {},
    default: ƒ assert(length: 0) {
        AssertionError: [Circular: *3],
        ok: <ref *7> ƒ ok(length: 0) {},
        fail: <ref *8> ƒ fail(length: 1) {},
        equal: <ref *9> ƒ equal(length: 2) {},
        notEqual: <ref *10> ƒ notEqual(length: 2) {},
        deepEqual: [Circular: *4],
        notDeepEqual: <ref *11> ƒ notDeepEqual(length: 2) {},
        deepStrictEqual: [Circular: *5],
        notDeepStrictEqual: <ref *12> ƒ notDeepStrictEqual(length: 2) {},
        strictEqual: <ref *13> ƒ strictEqual(length: 2) {},
        notStrictEqual: <ref *14> ƒ notStrictEqual(length: 2) {},
        partialDeepStrictEqual: <ref *15> ƒ partialDeepStrictEqual(length: 2) {},
        match: <ref *16> ƒ match(length: 2) {},
        doesNotMatch: <ref *17> ƒ doesNotMatch(length: 2) {},
...
[Object: null prototype] {
    Assert: <ref *2> ƒ Assert(length: 1) {},
    AssertionError: <ref *3> class AssertionError extends h {},
    ...
    default: <ref *7> ƒ assert(length: 0) {
...
[Object: null prototype] {
    Assert: <ref *2> ƒ Assert(length: 1) {},
    AssertionError: <ref *3> class AssertionError extends Error {},
    deepEqual: <ref *4> ƒ deepStrictEqual(length: 2) {},
    deepStrictEqual: [Circular: *4],
    default: <ref *5> ƒ strict(length: 0) {
        AssertionError: [Circular: *3],
        ok: <ref *6> ƒ ok(length: 0) {},
        fail: <ref *7> ƒ fail(length: 1) {},
        equal: <ref *8> ƒ strictEqual(length: 2) {},
        notEqual: <ref *9> ƒ notStrictEqual(length: 2) {},
        deepEqual: [Circular: *4],
        notDeepEqual: <ref *10> ƒ notDeepStrictEqual(length: 2) {},
        deepStrictEqual: [Circular: *4],
        notDeepStrictEqual: [Circular: *10],
        strictEqual: [Circular: *8],
        notStrictEqual: [Circular: *9],
        partialDeepStrictEqual: <ref *11> ƒ partialDeepStrictEqual(length: 2) {},
        match: <ref *12> ƒ match(length: 2) {},
        doesNotMatch: <ref *13> ƒ doesNotMatch(length: 2) {},
...
```js
[Object: null prototype] {
    AssertionError: <ref *2> class AssertionError extends h {},
    deepEqual: <ref *3> ƒ deepEqual(length: 3) {},
    deepStrictEqual: <ref *4> ƒ deepStrictEqual(length: 3) {},
    default: <ref *5> ƒ strict(length: 0) {
        Assert: <ref *6> ƒ Assert(length: 1) {},
        AssertionError: [Circular: *2],
        CallTracker: <ref *7> ƒ deprecated(length: 0) {},
        deepEqual: [Circular: *4],
        deepStrictEqual: [Circular: *4],
        doesNotMatch: <ref *8> ƒ doesNotMatch(length: 3) {},
        doesNotReject: <ref *9> async ƒ doesNotReject(length: 1) {},
        doesNotThrow: <ref *10> ƒ doesNotThrow(length: 1) {},
        equal: <ref *11> ƒ strictEqual(length: 3) {},
        fail: <ref *12> ƒ fail(length: 5) {},
        ifError: <ref *13> ƒ ifError(length: 1) {},
        match: <ref *14> ƒ match(length: 3) {},
        notDeepEqual: <ref *15> ƒ notDeepStrictEqual(length: 3) {},
        notDeepStrictEqual: [Circular: *15],
        notEqual: <ref *16> ƒ notStrictEqual(length: 3) {},
        notStrictEqual: [Circular: *16],
        ok: <ref *17> ƒ assert(length: 0) {
            fail: [Circular: *12],
            equal: <ref *18> ƒ equal(length: 3) {},
            notEqual: <ref *19> ƒ notEqual(length: 3) {},
            deepEqual: [Circular: *3],
            notDeepEqual: <ref *20> ƒ notDeepEqual(length: 3) {},
            deepStrictEqual: [Circular: *4],
            notDeepStrictEqual: [Circular: *15],
            strictEqual: [Circular: *11],
            notStrictEqual: [Circular: *16],
            partialDeepStrictEqual: <ref *21> ƒ partialDeepStrictEqual(length: 3) {},
            match: [Circular: *14],
            doesNotMatch: [Circular: *8],
            throws: <ref *22> ƒ throws(length: 1) {},
            rejects: <ref *23> async ƒ rejects(length: 1) {},
            doesNotThrow: [Circular: *10],
            doesNotReject: [Circular: *9],
            ifError: [Circular: *13],
            Assert: [Circular: *6],
            AssertionError: [Circular: *2],
            CallTracker: [Circular: *7],
            ok: [Circular: *17],
            strict: [Circular: *5]
        },
        partialDeepStrictEqual: [Circular: *21],
        rejects: [Circular: *23],
        strict: [Circular: *5],
        strictEqual: [Circular: *11],
        throws: [Circular: *22]
...
[Object: null prototype] {
    ...
    Buffer: <ref *3> ƒ Buffer(length: 3) {
        ...
        allocUnsafe: ƒ allocUnsafe(length: 2) {},
        allocUnsafeSlow: ƒ allocUnsafeSlow(length: 2) {},
...
```js
[Object: null prototype] {
    ChildProcess: <ref *2> class ChildProcess extends Oe {},
    default: {
...
[Object: null prototype] {
    ...
    default: {
        ...
        table: <ref *15> ƒ table(length: 0) {},
        time: <ref *16> ƒ time(length: 0) {},
        timeLog: <ref *17> ƒ timeLog(length: 0) {},
        timeEnd: <ref *18> ƒ timeEnd(length: 0) {},
        group: <ref *19> ƒ group(length: 0) {},
        groupCollapsed: <ref *20> ƒ groupCollapsed(length: 0) {},
        groupEnd: <ref *21> ƒ groupEnd(length: 0) {},
        clear: [Circular: *4],
        trace: <ref *22> ƒ trace(length: 0) {},
        profile: <ref *23> ƒ profile(length: 0) {},
        profileEnd: <ref *24> ƒ profileEnd(length: 0) {},
        timeStamp: <ref *25> ƒ timeStamp(length: 0) {},
        indentLevel: 0,
    ...
    error: [Circular: *14],
    group: [Circular: *19],
    groupCollapsed: [Circular: *20],
    groupEnd: [Circular: *21],
    indentLevel: 0,
    info: [Circular: *10],
    log: [Circular: *9],
    profile: [Circular: *23],
    profileEnd: [Circular: *24],
    table: [Circular: *15],
    time: [Circular: *16],
    timeEnd: [Circular: *18],
    timeLog: [Circular: *17],
    timeStamp: [Circular: *25],
    trace: [Circular: *22],
    warn: [Circular: *13]
}
...
[Object: null prototype] {
    ...
    default: {
        ...
        randomUUIDv7: <ref *61> ƒ randomUUIDv7(length: 1) {},
        scrypt: <ref *62> ƒ scrypt(length: 4) {},
        scryptSync: <ref *63> ƒ scryptSync(length: 3) {},
        sign: <ref *64> ƒ signOneShot(length: 4) {},
        setEngine: <ref *65> ƒ setEngine(length: 2) {},
        timingSafeEqual: <ref *66> ƒ (length: 0) {},
        getFips: <ref *67> ƒ getFips(length: 0) {},
        setFips: <ref *68> ƒ setFips(length: 1) {},
        verify: <ref *69> ƒ verifyOneShot(length: 5) {},
        hash: <ref *70> ƒ hash(length: 3) {},
        encapsulate: <ref *71> ƒ encapsulate(length: 2) {},
        ...
        secureHeapUsed: <ref *72> ƒ secureHeapUsed(length: 0) {},
        constants: [Circular: *22],
        [get/set] webcrypto: <ref *73> Crypto {},
        [get/set] subtle: <ref *74> SubtleCrypto {},
        [get/set] getRandomValues: <ref *75> ƒ getRandomValues(length: 1) {}
    },
    diffieHellman: [Circular: *37],
    encapsulate: [Circular: *71],
    ...
    randomUUIDv7: [Circular: *61],
    scrypt: [Circular: *62],
    scryptSync: [Circular: *63],
    secureHeapUsed: [Circular: *72],
    setEngine: [Circular: *65],
    setFips: [Circular: *68],
    sign: [Circular: *64],
    subtle: [Circular: *74],
    timingSafeEqual: [Circular: *66],
    verify: [Circular: *69],
    webcrypto: [Circular: *73]
}
...
[Object: null prototype] {
    ...
    default: {
        ...
        Decipheriv: [Circular: *7],
        DiffieHellman: [Circular: *8],
        diffieHellman: <ref *34> ƒ diffieHellman(length: 2) {},
        DiffieHellmanGroup: [Circular: *9],
        ECDH: [Circular: *10],
        getRandomValues: <ref *35> ƒ getRandomValues(length: 1) {},
        generateKey: <ref *36> ƒ generateKey(length: 3) {},
        generateKeyPair: <ref *37> ƒ generateKeyPair(length: 3) {},
        generateKeyPairSync: <ref *38> ƒ generateKeyPairSync(length: 2) {},
        generateKeySync: <ref *39> ƒ generateKeySync(length: 2) {},
        generatePrime: <ref *40> ƒ generatePrime(length: 1) {},
        generatePrimeSync: <ref *41> ƒ generatePrimeSync(length: 1) {},
        getCipherInfo: <ref *42> ƒ getCipherInfo(length: 2) {},
        getCiphers: <ref *43> ƒ getCiphers(length: 0) {},
        getCurves: <ref *44> ƒ getCurves(length: 0) {},
        getDiffieHellman: [Circular: *24],
        getFips: <ref *45> ƒ getFipsCrypto(length: 0) {},
        getHashes: <ref *46> ƒ getHashes(length: 0) {},
        hash: <ref *47> ƒ hash(length: 2) {},
        Hash: [Circular: *12],
        hkdf: <ref *48> ƒ hkdf(length: 6) {},
        hkdfSync: <ref *49> ƒ hkdfSync(length: 5) {},
        Hmac: [Circular: *13],
        KeyObject: [Circular: *14],
        pbkdf2: <ref *50> ƒ pbkdf2(length: 6) {},
        pbkdf2Sync: <ref *51> ƒ pbkdf2Sync(length: 5) {},
        privateDecrypt: <ref *52> ƒ privateDecrypt(length: 2) {},
        privateEncrypt: <ref *53> ƒ privateEncrypt(length: 2) {},
        publicDecrypt: <ref *54> ƒ publicDecrypt(length: 2) {},
        publicEncrypt: <ref *55> ƒ publicEncrypt(length: 2) {},
        randomBytes: <ref *56> ƒ randomBytes(length: 2) {},
        randomFill: <ref *57> ƒ randomFill(length: 4) {},
        randomFillSync: <ref *58> ƒ randomFillSync(length: 1) {},
        randomInt: <ref *59> ƒ randomInt(length: 3) {},
        randomUUID: <ref *60> ƒ randomUUID(length: 1) {},
        scrypt: <ref *61> ƒ scrypt(length: 5) {},
        scryptSync: <ref *62> ƒ scryptSync(length: 4) {},
        secureHeapUsed: <ref *63> ƒ secureHeapUsed(length: 0) {},
        setEngine: <ref *64> ƒ setEngine(length: 2) {},
        setFips: <ref *65> ƒ setFipsCrypto(length: 1) {},
        Sign: [Circular: *15],
        sign: <ref *66> ƒ signOneShot(length: 4) {},
        timingSafeEqual: <ref *67> ƒ timingSafeEqual(length: 2) {},
        Verify: [Circular: *16],
        verify: <ref *68> ƒ verifyOneShot(length: 5) {},
        webcrypto: <ref *69> Crypto {
            Symbol([[webidl.brand]]): Symbol([[webidl.brand]])
        },
        subtle: <ref *70> SubtleCrypto {
            Symbol([[webidl.brand]]): Symbol([[webidl.brand]])
        },
        X509Certificate: [Circular: *17]
    },
    diffieHellman: [Circular: *34],
    generateKey: [Circular: *36],
    generateKeyPair: [Circular: *37],
    generateKeyPairSync: [Circular: *38],
    generateKeySync: [Circular: *39],
    generatePrime: [Circular: *40],
    generatePrimeSync: [Circular: *41],
    getCipherInfo: [Circular: *42],
    getCiphers: [Circular: *43],
    getCurves: [Circular: *44],
    getDiffieHellman: [Circular: *24],
    getFips: [Circular: *45],
    getHashes: [Circular: *46],
    getRandomValues: [Circular: *35],
    hash: [Circular: *47],
    hkdf: [Circular: *48],
    hkdfSync: [Circular: *49],
    pbkdf2: [Circular: *50],
    pbkdf2Sync: [Circular: *51],
    privateDecrypt: [Circular: *52],
    privateEncrypt: [Circular: *53],
    pseudoRandomBytes: [Circular: *56],
    publicDecrypt: [Circular: *54],
    publicEncrypt: [Circular: *55],
    randomBytes: [Circular: *56],
    randomFill: [Circular: *57],
    ...
    secureHeapUsed: [Circular: *63],
    setEngine: [Circular: *64],
    setFips: [Circular: *65],
    sign: [Circular: *66],
    subtle: [Circular: *70],
    timingSafeEqual: [Circular: *67],
    verify: [Circular: *68],
...
```js
[Object: null prototype] {
    Socket: <ref *2> class Socket extends m {},
    createSocket: <ref *3> ƒ createSocket(length: 2) {},
    default: {
        createSocket: [Circular: *3],
        Socket: [Circular: *2]
...
```js
[Object: null prototype] {
    BoundedChannel: <ref *2> class BoundedChannel {},
    Channel: <ref *3> class Channel {},
    boundedChannel: <ref *4> ƒ boundedChannel(length: 1) {},
    channel: <ref *5> ƒ channel(length: 1) {},
    default: {
        channel: [Circular: *5],
        hasSubscribers: <ref *7> ƒ hasSubscribers(length: 1) {},
        subscribe: <ref *8> ƒ subscribe(length: 2) {},
        tracingChannel: <ref *9> ƒ tracingChannel(length: 1) {},
        unsubscribe: <ref *10> ƒ unsubscribe(length: 2) {},
        boundedChannel: [Circular: *4],
        Channel: [Circular: *3],
        BoundedChannel: [Circular: *2]
    },
    hasSubscribers: [Circular: *7],
    subscribe: [Circular: *8],
    tracingChannel: [Circular: *9],
    unsubscribe: [Circular: *10]
}
...
[Object: null prototype] {
    ...
    NOTINITIALIZED: "ENOTINITIALIZED",
    REFUSED: "EREFUSED",
    Resolver: <ref *2> class Resolver extends g {},
    SERVFAIL: "ESERVFAIL",
    TIMEOUT: "ETIMEOUT",
    V4MAPPED: 16,
    default: {
        ...
        getDefaultResultOrder: <ref *22> ƒ getDefaultDnsOrder(length: 0) {},
        setDefaultResultOrder: <ref *23> ƒ setDefaultResultOrder(length: 1) {},
        promises: <ref *24> {
            lookup: ƒ lookup(length: 2) {},
            lookupService: ƒ lookupService(length: 2) {},
            Resolver: class Resolver extends y {},
            getDefaultResultOrder: [Circular: *22],
            ...
            setDefaultResultOrder: [Circular: *23],
...
[Object: null prototype] {
    ...
    NOTINITIALIZED: "ENOTINITIALIZED",
    REFUSED: "EREFUSED",
    Resolver: <ref *2> class Resolver extends y {},
    SERVFAIL: "ESERVFAIL",
    TIMEOUT: "ETIMEOUT",
    default: {
        lookup: <ref *4> ƒ lookup(length: 2) {},
        lookupService: <ref *5> ƒ lookupService(length: 2) {},
        Resolver: [Circular: *2],
        getDefaultResultOrder: <ref *6> ƒ getDefaultDnsOrder(length: 0) {},
        getServers: <ref *7> ƒ getServers(length: 0) {},
        resolveAny: <ref *8> ƒ resolveAny(length: 1) {},
        resolve4: <ref *9> ƒ resolve4(length: 2) {},
        resolve6: <ref *10> ƒ resolve6(length: 2) {},
        resolveCaa: <ref *11> ƒ resolveCaa(length: 1) {},
        resolveCname: <ref *12> ƒ resolveCname(length: 1) {},
        resolveMx: <ref *13> ƒ resolveMx(length: 1) {},
        resolveNs: <ref *14> ƒ resolveNs(length: 1) {},
        resolveTxt: <ref *15> ƒ resolveTxt(length: 1) {},
        resolveSrv: <ref *16> ƒ resolveSrv(length: 1) {},
        resolvePtr: <ref *17> ƒ resolvePtr(length: 1) {},
        resolveNaptr: <ref *18> ƒ resolveNaptr(length: 1) {},
        resolveSoa: <ref *19> ƒ resolveSoa(length: 1) {},
        resolve: <ref *20> ƒ resolve(length: 2) {},
        reverse: <ref *21> ƒ reverse(length: 1) {},
        setDefaultResultOrder: <ref *22> ƒ setDefaultResultOrder(length: 1) {},
        setServers: <ref *23> ƒ setServers(length: 1) {},
        NODATA: "ENODATA",
        FORMERR: "EFORMERR",
        SERVFAIL: "ESERVFAIL",
        NOTFOUND: "ENOTFOUND",
    ...
    getDefaultResultOrder: [Circular: *6],
    getServers: [Circular: *7],
    lookup: [Circular: *4],
    lookupService: [Circular: *5],
    resolve: [Circular: *20],
    resolve4: [Circular: *9],
    resolve6: [Circular: *10],
    resolveAny: [Circular: *8],
    resolveCaa: [Circular: *11],
    resolveCname: [Circular: *12],
    resolveMx: [Circular: *13],
    resolveNaptr: [Circular: *18],
    resolveNs: [Circular: *14],
    resolvePtr: [Circular: *17],
    resolveSoa: [Circular: *19],
    resolveSrv: [Circular: *16],
    resolveTxt: [Circular: *15],
    reverse: [Circular: *21],
    setDefaultResultOrder: [Circular: *22],
    setServers: [Circular: *23]
}
...
```js
[Object: null prototype] {
    Domain: <ref *2> class Domain extends g {},
    _stack: <ref *3> [],
    active: null,
...
[Object: null prototype] {
    EventEmitter: <ref *2> ƒ EventEmitter(length: 1) {
        ...
        [get/set] EventEmitterAsyncResource: <ref *9> class EventEmitterAsyncResource extends EventEmitter {},
        errorMonitor: Symbol(events.errorMonitor),
        [get/set] defaultMaxListeners: 10,
        setMaxListeners: <ref *10> ƒ (length: 0) {},
        init: <ref *11> ƒ (length: 1) {}
    },
    EventEmitterAsyncResource: [Circular: *9],
...
[Object: null prototype] {
    EventEmitter: <ref *2> ƒ EventEmitter(length: 1) {
        ...
        getMaxListeners: <ref *7> ƒ getMaxListeners(length: 1) {},
        listenerCount: <ref *8> ƒ listenerCount(length: 2) {},
        addAbortListener: <ref *9> ƒ addAbortListener(length: 2) {},
        EventEmitter: [Circular: *2],
        usingDomains: false,
        captureRejectionSymbol: Symbol(nodejs.rejection),
        errorMonitor: Symbol(events.errorMonitor),
        ...
        [get/set] defaultMaxListeners: 10,
        init: ƒ (length: 1) {},
        [get/set] EventEmitterAsyncResource: <ref *11> class EventEmitterAsyncResource extends EventEmitter {}
    },
    EventEmitterAsyncResource: [Circular: *11],
    addAbortListener: [Circular: *9],
    captureRejectionSymbol: Symbol(nodejs.rejection),
    default: [Circular: *2],
    defaultMaxListeners: 10,
    errorMonitor: Symbol(events.errorMonitor),
...
[Object: null prototype] {
    ...
    Stats: <ref *6> ƒ deprecated(length: 18) {},
...
```js
[Object: null prototype] {
    BigIntStats: <ref *2> ƒ BigIntStats(length: 14) {},
    CFISBIS: <ref *3> ƒ CFISBIS(length: 2) {},
    Dir: <ref *4> class Dir {},
    ...
    Utf8Stream: <ref *9> class Utf8Stream extends r {},
    WriteStream: <ref *10> ƒ WriteStream(length: 2) {},
    _toUnixTimestamp: <ref *11> ƒ toUnixTimestamp(length: 1) {},
    access: <ref *12> ƒ access(length: 3) {},
    accessSync: <ref *13> ƒ accessSync(length: 2) {},
    appendFile: <ref *14> ƒ appendFile(length: 4) {},
    appendFileSync: <ref *15> ƒ appendFileSync(length: 3) {},
    chmod: <ref *16> ƒ chmod(length: 3) {},
    chmodSync: <ref *17> ƒ chmodSync(length: 2) {},
    chown: <ref *18> ƒ chown(length: 4) {},
    chownSync: <ref *19> ƒ chownSync(length: 3) {},
    close: <ref *20> ƒ close(length: 1) {},
    closeSync: <ref *21> ƒ closeSync(length: 1) {},
    constants: <ref *22> [Object: null prototype] {
        F_OK: 0,
        R_OK: 4,
        W_OK: 2,
    ...
    convertFileInfoToBigIntStats: <ref *23> ƒ convertFileInfoToBigIntStats(length: 1) {},
    convertFileInfoToStats: <ref *24> ƒ convertFileInfoToStats(length: 1) {},
    copyFile: <ref *25> ƒ copyFile(length: 4) {},
    copyFileSync: <ref *26> ƒ copyFileSync(length: 3) {},
    cp: <ref *27> ƒ cp(length: 4) {},
    cpSync: <ref *28> ƒ cpSync(length: 3) {},
    createReadStream: <ref *29> ƒ createReadStream(length: 2) {},
    createWriteStream: <ref *30> ƒ createWriteStream(length: 2) {},
    default: {
        _toUnixTimestamp: [Circular: *11],
        access: [Circular: *12],
        accessSync: [Circular: *13],
        appendFile: [Circular: *14],
        appendFileSync: [Circular: *15],
        BigIntStats: [Circular: *2],
        CFISBIS: [Circular: *3],
        chmod: [Circular: *16],
        chmodSync: [Circular: *17],
        chown: [Circular: *18],
        chownSync: [Circular: *19],
        close: [Circular: *20],
        closeSync: [Circular: *21],
        constants: [Circular: *22],
        convertFileInfoToBigIntStats: [Circular: *23],
        convertFileInfoToStats: [Circular: *24],
        copyFile: [Circular: *25],
        copyFileSync: [Circular: *26],
        cp: [Circular: *27],
        cpSync: [Circular: *28],
        [get/set] createReadStream: [Circular: *29],
        [get/set] createWriteStream: [Circular: *30],
        Dir: [Circular: *4],
        Dirent: [Circular: *5],
        exists: <ref *32> ƒ exists(length: 2) {},
        existsSync: <ref *33> ƒ existsSync(length: 1) {},
        fchmod: <ref *34> ƒ fchmod(length: 3) {},
        fchmodSync: <ref *35> ƒ fchmodSync(length: 2) {},
        fchown: <ref *36> ƒ fchown(length: 4) {},
        fchownSync: <ref *37> ƒ fchownSync(length: 3) {},
        fdatasync: <ref *38> ƒ fdatasync(length: 2) {},
        fdatasyncSync: <ref *39> ƒ fdatasyncSync(length: 1) {},
        fstat: <ref *40> ƒ fstat(length: 3) {},
        fstatSync: <ref *41> ƒ fstatSync(length: 2) {},
        fsync: <ref *42> ƒ fsync(length: 2) {},
        fsyncSync: <ref *43> ƒ fsyncSync(length: 1) {},
        ftruncate: <ref *44> ƒ ftruncate(length: 1) {},
        ftruncateSync: <ref *45> ƒ ftruncateSync(length: 1) {},
        futimes: <ref *46> ƒ futimes(length: 4) {},
        futimesSync: <ref *47> ƒ futimesSync(length: 3) {},
        glob: <ref *48> ƒ glob(length: 2) {},
        globSync: <ref *49> ƒ globSync(length: 1) {},
        lchmod: undefined,
        lchmodSync: undefined,
        lchown: <ref *50> ƒ lchown(length: 4) {},
        lchownSync: <ref *51> ƒ lchownSync(length: 3) {},
        link: <ref *52> ƒ link(length: 3) {},
        linkSync: <ref *53> ƒ linkSync(length: 2) {},
        lstat: <ref *54> ƒ lstat(length: 3) {},
        lstatSync: <ref *55> ƒ lstatSync(length: 2) {},
        lutimes: <ref *56> ƒ lutimes(length: 4) {},
        lutimesSync: <ref *57> ƒ lutimesSync(length: 3) {},
        mkdir: <ref *58> ƒ mkdir(length: 3) {},
        mkdirSync: <ref *59> ƒ mkdirSync(length: 2) {},
        mkdtemp: <ref *60> ƒ mkdtemp(length: 3) {},
        mkdtempDisposableSync: <ref *61> ƒ mkdtempDisposableSync(length: 2) {},
        mkdtempSync: <ref *62> ƒ mkdtempSync(length: 2) {},
        open: <ref *63> ƒ open(length: 4) {},
        openAsBlob: <ref *64> ƒ openAsBlob(length: 1) {},
        opendir: <ref *65> ƒ opendir(length: 3) {},
        opendirSync: <ref *66> ƒ opendirSync(length: 2) {},
        openSync: <ref *67> ƒ openSync(length: 1) {},
        [get/set] promises: <ref *68> {
            access: ƒ (length: 0) {},
            constants: [Circular: *22],
            ...
            opendir: ƒ (length: 0) {},
            rename: ƒ (length: 0) {},
            truncate: async ƒ truncatePromise(length: 2) {},
            rm: ƒ (length: 0) {},
            rmdir: ƒ (length: 0) {},
            mkdir: ƒ (length: 0) {},
            ...
            realpath: ƒ (length: 0) {},
            mkdtemp: ƒ (length: 0) {},
            mkdtempDisposable: async ƒ mkdtempDisposablePromise(length: 2) {},
            writeFile: ƒ writeFilePromise(length: 3) {},
            appendFile: ƒ appendFilePromise(length: 3) {},
            readFile: ƒ readFilePromise(length: 2) {},
            watch: ƒ watch(length: 0) {}
        },
        read: <ref *101> ƒ read(length: 6) {},
        readdir: <ref *102> ƒ readdir(length: 3) {},
        readdirSync: <ref *103> ƒ readdirSync(length: 2) {},
        readFile: <ref *104> ƒ readFile(length: 3) {},
        readFilePromise: <ref *105> ƒ readFilePromise(length: 2) {},
        readFileSync: <ref *106> ƒ readFileSync(length: 2) {},
        readlink: <ref *107> ƒ readlink(length: 3) {},
        readlinkPromise: <ref *108> ƒ readlink(length: 3) {},
        readlinkSync: <ref *109> ƒ readlinkSync(length: 2) {},
        [get/set] ReadStream: [Circular: *6],
        readSync: <ref *110> ƒ readSync(length: 5) {},
        readv: <ref *111> ƒ readv(length: 4) {},
        readvPromise: <ref *112> ƒ readvPromise(length: 3) {},
        readvSync: <ref *113> ƒ readvSync(length: 2) {},
        realpath: <ref *114> ƒ realpath(length: 3) {
            native: ƒ realpath_native(length: 3) {}
        },
        realpathSync: <ref *116> ƒ realpathSync(length: 2) {
            native: ƒ realpathSync_native(length: 2) {}
        },
        rename: <ref *118> ƒ rename(length: 3) {},
        renameSync: <ref *119> ƒ renameSync(length: 2) {},
        rm: <ref *120> ƒ rm(length: 3) {},
        rmdir: <ref *121> ƒ rmdir(length: 3) {},
        rmdirSync: <ref *122> ƒ rmdirSync(length: 2) {},
        rmSync: <ref *123> ƒ rmSync(length: 2) {},
        stat: <ref *124> ƒ stat(length: 1) {},
        Stats: [Circular: *7],
        statfs: <ref *125> ƒ statfs(length: 3) {},
        statfsSync: <ref *126> ƒ statfsSync(length: 2) {},
        statSync: <ref *127> ƒ statSync(length: 1) {},
        symlink: <ref *128> ƒ symlink(length: 4) {},
        symlinkSync: <ref *129> ƒ symlinkSync(length: 3) {},
        SyncWriteStream: [Circular: *8],
        truncate: <ref *130> ƒ truncate(length: 1) {},
        truncateSync: <ref *131> ƒ truncateSync(length: 1) {},
        unlink: <ref *132> ƒ unlink(length: 2) {},
        unlinkSync: <ref *133> ƒ unlinkSync(length: 1) {},
        unwatchFile: <ref *134> ƒ unwatchFile(length: 2) {},
        [get/set] Utf8Stream: [Circular: *9],
        utimes: <ref *135> ƒ utimes(length: 4) {},
        utimesSync: <ref *136> ƒ utimesSync(length: 3) {},
        watch: <ref *137> ƒ watch(length: 3) {},
        watchFile: <ref *138> ƒ watchFile(length: 3) {},
        watchPromise: <ref *139> ƒ watchPromise(length: 2) {},
        write: <ref *140> ƒ write(length: 6) {},
        writeFile: <ref *141> ƒ writeFile(length: 4) {},
        writeFileSync: <ref *142> ƒ writeFileSync(length: 3) {},
        [get/set] WriteStream: [Circular: *10],
        writeSync: <ref *143> ƒ writeSync(length: 5) {},
        writev: <ref *144> ƒ writev(length: 4) {},
        writevSync: <ref *145> ƒ writevSync(length: 3) {}
    },
    exists: [Circular: *32],
    existsSync: [Circular: *33],
    fchmod: [Circular: *34],
    fchmodSync: [Circular: *35],
    fchown: [Circular: *36],
    fchownSync: [Circular: *37],
    fdatasync: [Circular: *38],
    fdatasyncSync: [Circular: *39],
    fstat: [Circular: *40],
    fstatSync: [Circular: *41],
    fsync: [Circular: *42],
    fsyncSync: [Circular: *43],
    ftruncate: [Circular: *44],
    ftruncateSync: [Circular: *45],
    futimes: [Circular: *46],
    futimesSync: [Circular: *47],
    glob: [Circular: *48],
    globSync: [Circular: *49],
    lchmod: undefined,
    lchmodSync: undefined,
    lchown: [Circular: *50],
    lchownSync: [Circular: *51],
    link: [Circular: *52],
    linkSync: [Circular: *53],
    lstat: [Circular: *54],
    lstatSync: [Circular: *55],
    lutimes: [Circular: *56],
    lutimesSync: [Circular: *57],
    mkdir: [Circular: *58],
    mkdirSync: [Circular: *59],
    mkdtemp: [Circular: *60],
    mkdtempDisposableSync: [Circular: *61],
    mkdtempSync: [Circular: *62],
    open: [Circular: *63],
    openAsBlob: [Circular: *64],
    openSync: [Circular: *67],
    opendir: [Circular: *65],
    opendirSync: [Circular: *66],
    promises: [Circular: *68],
    read: [Circular: *101],
    readFile: [Circular: *104],
    readFilePromise: [Circular: *105],
    readFileSync: [Circular: *106],
    readSync: [Circular: *110],
    readdir: [Circular: *102],
    readdirSync: [Circular: *103],
    readlink: [Circular: *107],
    readlinkPromise: [Circular: *108],
    readlinkSync: [Circular: *109],
    readv: [Circular: *111],
    readvPromise: [Circular: *112],
    readvSync: [Circular: *113],
    realpath: [Circular: *114],
    realpathSync: [Circular: *116],
    rename: [Circular: *118],
    renameSync: [Circular: *119],
    rm: [Circular: *120],
    rmSync: [Circular: *123],
    rmdir: [Circular: *121],
    rmdirSync: [Circular: *122],
    stat: [Circular: *124],
    statSync: [Circular: *127],
    statfs: [Circular: *125],
    statfsSync: [Circular: *126],
    symlink: [Circular: *128],
    symlinkSync: [Circular: *129],
    truncate: [Circular: *130],
    truncateSync: [Circular: *131],
    unlink: [Circular: *132],
    unlinkSync: [Circular: *133],
    unwatchFile: [Circular: *134],
    utimes: [Circular: *135],
    utimesSync: [Circular: *136],
    watch: [Circular: *137],
    watchFile: [Circular: *138],
    watchPromise: [Circular: *139],
    write: [Circular: *140],
    writeFile: [Circular: *141],
    writeFileSync: [Circular: *142],
    writeSync: [Circular: *143],
    writev: [Circular: *144],
    writevSync: [Circular: *145]
}
...
[Object: null prototype] {
    ...
    appendFile: <ref *3> ƒ appendFilePromise(length: 3) {},
    ...
    default: {
        ...
        opendir: <ref *12> ƒ (length: 0) {},
        rename: <ref *13> ƒ (length: 0) {},
        truncate: <ref *14> async ƒ truncatePromise(length: 2) {},
        rm: <ref *15> ƒ (length: 0) {},
        rmdir: <ref *16> ƒ (length: 0) {},
        mkdir: <ref *17> ƒ (length: 0) {},
        readdir: <ref *18> ƒ readdir(length: 3) {},
        readlink: <ref *19> ƒ (length: 0) {},
        symlink: <ref *20> ƒ (length: 0) {},
        lstat: <ref *21> ƒ lstat(length: 3) {},
        stat: <ref *22> ƒ (length: 0) {},
        statfs: <ref *23> ƒ (length: 0) {},
        link: <ref *24> ƒ (length: 0) {},
        unlink: <ref *25> ƒ (length: 0) {},
        chmod: [Circular: *4],
        lchmod: <ref *26> ƒ (length: 0) {},
        lchown: <ref *27> ƒ (length: 0) {},
        chown: [Circular: *5],
        utimes: <ref *28> ƒ (length: 0) {},
        lutimes: <ref *29> ƒ lutimes(length: 4) {},
        realpath: <ref *30> ƒ (length: 0) {},
        mkdtemp: <ref *31> ƒ (length: 0) {},
        mkdtempDisposable: <ref *32> async ƒ mkdtempDisposablePromise(length: 2) {},
        writeFile: <ref *33> ƒ writeFilePromise(length: 3) {},
        appendFile: [Circular: *3],
        readFile: <ref *34> ƒ readFilePromise(length: 2) {},
        watch: <ref *35> ƒ watch(length: 0) {}
    },
    glob: [Circular: *10],
    lchmod: [Circular: *26],
    lchown: [Circular: *27],
...
[Object: null prototype] {
    ...
    get: [Circular: *20],
    globalAgent: [Circular: *24],
    maxHeaderSize: 16384,
    request: [Circular: *21],
    setGlobalProxyFromEnv: [Circular: *23],
...
[Object: null prototype] {
    ...
    default: {
        ...
        get: <ref *13> ƒ get(length: 0) {},
        [get/set] globalAgent: <ref *14> Agent {
            _events: [Object: null prototype] {
                free: ƒ (length: 2) {},
                newListener: ƒ maybeEnableKeylog(length: 1) {}
            },
        ...
        request: <ref *22> ƒ request(length: 0) {},
        Server: [Circular: *8],
        ServerImpl: [Circular: *8],
        ServerResponse: [Circular: *9],
        setGlobalProxyFromEnv: ƒ setGlobalProxyFromEnv(length: 1) {},
        setMaxIdleHTTPParsers: <ref *24> ƒ setMaxIdleHTTPParsers(length: 1) {},
        STATUS_CODES: [Circular: *7],
        validateHeaderName: <ref *25> ƒ __node_internal_(length: 0) {
            withoutStackTrace: ƒ __node_internal_(length: 2) {}
        },
        validateHeaderValue: <ref *27> ƒ __node_internal_(length: 0) {
            withoutStackTrace: ƒ __node_internal_(length: 2) {}
        }
    },
    get: [Circular: *13],
    ...
    maxHeaderSize: 16384,
    request: [Circular: *22],
    setMaxIdleHTTPParsers: [Circular: *24],
    validateHeaderName: [Circular: *25],
...
[Object: null prototype] {
    ...
    Http2ServerRequest: <ref *3> class Http2ServerRequest extends C().Readable {},
    Http2ServerResponse: <ref *4> class Http2ServerResponse extends C().default {},
    Http2Session: <ref *5> class Http2Session extends nt {},
    Http2Stream: <ref *6> class Http2Stream extends Ge {},
    ServerHttp2Session: <ref *7> class ServerHttp2Session extends Http2Session {},
    addAbortListener: <ref *8> ƒ addAbortListener(length: 2) {},
    ...
    default: {
        ...
        Http2Session: [Circular: *5],
        Http2Stream: [Circular: *6],
        performServerHandshake: <ref *17> ƒ performServerHandshake(length: 1) {},
        sensitiveHeaders: Symbol(sensitiveHeaders),
        ServerHttp2Session: [Circular: *7]
    },
...
[Object: null prototype] {
    ...
    default: {
        ...
        [get/set] globalAgent: <ref *7> Agent {
            _events: [Object: null prototype] {
                free: ƒ (length: 2) {},
                newListener: ƒ maybeEnableKeylog(length: 1) {}
            },
        ...
        request: <ref *18> ƒ node:https:request(length: 0) {}
    },
    get: [Circular: *6],
...
[Object: null prototype] {
    DOMStorage: <ref *2> {
        domStorageItemAdded: ƒ domStorageItemAdded(length: 1) {},
        domStorageItemRemoved: ƒ domStorageItemRemoved(length: 1) {},
        domStorageItemUpdated: ƒ domStorageItemUpdated(length: 1) {},
        domStorageItemsCleared: ƒ domStorageItemsCleared(length: 1) {},
        registerStorage: ƒ registerStorage(length: 1) {}
    },
    Network: <ref *8> {
    ...
    NetworkResources: <ref *18> {
        put: ƒ put(length: 2) {}
    },
    Session: <ref *20> class Session extends EventEmitter {},
    close: <ref *21> ƒ _debugEnd(length: 0) {},
    console: <ref *22> {
    ...
    default: {
        open: <ref *47> ƒ inspectorOpen(length: 3) {},
        close: [Circular: *21],
        url: <ref *48> ƒ url(length: 0) {},
        waitForDebugger: <ref *49> ƒ inspectorWaitForDebugger(length: 0) {},
        console: [Circular: *22],
        Session: [Circular: *20],
        Network: [Circular: *8],
        NetworkResources: [Circular: *18],
        DOMStorage: [Circular: *2]
    },
    open: [Circular: *47],
    url: [Circular: *48],
    waitForDebugger: [Circular: *49]
}
...
[Object: null prototype] {
    ...
    Session: <ref *18> class Session extends h {},
    close: <ref *19> ƒ close(length: 0) {},
    console: <ref *20> {
        debug: ƒ debug(length: 0) {},
        error: ƒ error(length: 0) {},
        info: ƒ info(length: 0) {},
    ...
    default: {
        ...
        DOMStorage: [Circular: *2],
        Network: [Circular: *8],
        open: <ref *45> ƒ open(length: 3) {},
        Session: [Circular: *18],
        url: <ref *46> ƒ url(length: 0) {},
        waitForDebugger: <ref *47> ƒ waitForDebugger(length: 0) {}
    },
    open: [Circular: *45],
    url: [Circular: *46],
    waitForDebugger: [Circular: *47]
}
...
[Object: null prototype] {
    ...
    Session: <ref *20> class Session extends inspector.Session {},
    close: <ref *21> ƒ _debugEnd(length: 0) {},
    console: <ref *22> {
        debug: ƒ debug(length: 0) {},
        error: ƒ error(length: 0) {},
...
[Object: null prototype] {
    ...
    Session: <ref *18> class Session extends r.Session {},
    close: <ref *19> ƒ close(length: 0) {},
    console: <ref *20> {
        debug: ƒ debug(length: 0) {},
        error: ƒ error(length: 0) {},
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _pathCache: <ref *4> [Object: null prototype] {
            /tmp/fs-fixture-1789354379768-2167-1/module.mjs: "/tmp/fs-fixture-1789354379768-2167-1/module.mjs"
        },
        ...
        globalPaths: <ref *9> [
            "/home/runner/work/compare-deno-node/compare-deno-node/node_modules/.pnpm/tsx@4.20.3/node_modules/tsx…",
            "/home/runner/work/compare-deno-node/compare-deno-node/node_modules/.pnpm/tsx@4.20.3/node_modules/tsx…",
            "/home/runner/work/compare-deno-node/compare-deno-node/node_modules/.pnpm/tsx@4.20.3/node_modules",
            "/home/runner/work/compare-deno-node/compare-deno-node/node_modules/.pnpm/node_modules",
            ...
            "/opt/hostedtoolcache/node/26.8.2/x64/lib/node"
        ],
...
[Object: null prototype] {
    Module: <ref *2> ƒ Module(length: 0) {
        ...
        _preloadModules: <ref *18> ƒ (length: 1) {},
        isBuiltin: <ref *19> ƒ isBuiltin(length: 1) {},
        createRequire: <ref *20> ƒ createRequire(length: 1) {},
        findPackageJSON: <ref *21> ƒ findPackageJSON(length: 1) {},
        _initPaths: <ref *22> ƒ (length: 0) {},
        syncBuiltinESMExports: <ref *23> ƒ syncBuiltinESMExports(length: 0) {},
        runMain: <ref *24> ƒ (length: 0) {},
        Module: [Circular: *2],
        findSourceMap: <ref *25> ƒ findSourceMap(length: 1) {},
        SourceMap: <ref *26> class SourceMap {},
        stripTypeScriptTypes: <ref *27> ƒ stripTypeScriptTypes(length: 1) {},
        registerHooks: <ref *28> ƒ registerHooks(length: 1) {}
    },
    SourceMap: [Circular: *26],
    _cache: [Circular: *10],
    _extensions: [Circular: *4],
    _findPath: [Circular: *13],
    _initPaths: [Circular: *22],
    _load: [Circular: *16],
    ...
    _stat: ƒ op_require_stat(length: 2) {},
    builtinModules: [Circular: *3],
    createRequire: [Circular: *20],
    default: [Circular: *2],
    findPackageJSON: [Circular: *21],
    findSourceMap: [Circular: *25],
    getBuiltinModule: ƒ getBuiltinModule(length: 1) {},
    globalPaths: [Circular: *12],
    isBuiltin: [Circular: *19],
    register: ƒ register(length: 3) {},
    registerHooks: [Circular: *28],
    runMain: [Circular: *24],
    stripTypeScriptTypes: [Circular: *27],
    syncBuiltinESMExports: [Circular: *23],
...
Error importing module: No such built-in module: node:sea
    at file:///tmp/fs-fixture-1789354379768-2167-1/sea.mjs:3:32
...
```js
[Object: null prototype] {
    DatabaseSync: <ref *2> ƒ DatabaseSync(length: 2) {},
    StatementSync: <ref *3> ƒ StatementSync(length: 1) {},
    backup: <ref *4> ƒ backup(length: 2) {},
    constants: <ref *5> {
        SQLITE_CHANGESET_OMIT: 0,
        SQLITE_CHANGESET_REPLACE: 1,
        SQLITE_CHANGESET_ABORT: 2,
...
[Object: null prototype] {
    ...
    assert: <ref *4> [Object: null prototype] {
        register: ƒ register(length: 2) {}
    },
    before: <ref *6> ƒ (length: 2) {},
    beforeEach: <ref *7> ƒ (length: 2) {},
    default: <ref *8> ƒ test(length: 3) {
        expectFailure: <ref *9> ƒ (length: 3) {},
        skip: <ref *10> ƒ (length: 3) {},
        todo: <ref *11> ƒ (length: 3) {},
        only: <ref *12> ƒ (length: 3) {},
        after: [Circular: *2],
        afterEach: [Circular: *3],
        before: [Circular: *6],
        beforeEach: [Circular: *7],
        describe: <ref *13> ƒ test(length: 3) {
            expectFailure: ƒ (length: 3) {},
            skip: ƒ (length: 3) {},
            todo: ƒ (length: 3) {},
            only: ƒ (length: 3) {}
        },
        getTestContext: <ref *18> ƒ getTestContext(length: 0) {},
        it: [Circular: *8],
        run: <ref *19> ƒ run(length: 0) {},
        suite: [Circular: *13],
        test: [Circular: *8],
        [get/set] mock: <ref *20> MockTracker {},
        [get/set] snapshot: <ref *21> [Object: null prototype] {
        ...
        [get/set] assert: [Circular: *4]
    },
    describe: [Circular: *13],
    expectFailure: [Circular: *9],
    getTestContext: [Circular: *18],
    it: [Circular: *8],
    mock: [Circular: *20],
    only: [Circular: *12],
    run: [Circular: *19],
    skip: [Circular: *10],
    snapshot: [Circular: *21],
    suite: [Circular: *13],
    test: [Circular: *8],
    todo: [Circular: *11]
}
...
```js
[Object: null prototype] {
    after: <ref *2> ƒ after(length: 2) {},
    afterEach: <ref *3> ƒ afterEach(length: 2) {},
    before: <ref *4> ƒ before(length: 2) {},
    beforeEach: <ref *5> ƒ beforeEach(length: 2) {},
    default: <ref *6> ƒ test(length: 4) {
        skip: ƒ skip(length: 3) {},
        todo: ƒ todo(length: 3) {},
        only: ƒ only(length: 3) {},
        expectFailure: ƒ expectFailure(length: 3) {},
        it: [Circular: *6],
        describe: <ref *11> ƒ suite(length: 4) {
            skip: ƒ skip(length: 3) {},
            todo: ƒ todo(length: 3) {},
            only: ƒ only(length: 3) {}
        },
        ...
        afterEach: [Circular: *3],
        getTestContext: <ref *15> ƒ getTestContext(length: 0) {},
        test: [Circular: *6],
        mock: <ref *16> {
            fn: ƒ fn(length: 3) {},
            getter: ƒ getter(length: 4) {},
            method: ƒ method(length: 4) {},
            module: ƒ mockModule(length: 1) {},
            property: ƒ property(length: 3) {},
            reset: ƒ reset(length: 0) {},
            restoreAll: ƒ restoreAll(length: 0) {},
            setter: ƒ setter(length: 4) {},
            timers: {
                enable: ƒ enable(length: 1) {},
                reset: ƒ reset(length: 0) {},
                tick: ƒ tick(length: 1) {},
                runAll: ƒ runAll(length: 0) {},
                setTime: ƒ setTime(length: 1) {},
                Symbol(Symbol.dispose): ƒ [Symbol.dispose](length: 0) {}
            }
        },
        run: <ref *32> ƒ run(length: 1) {}
    },
    describe: [Circular: *11],
    getTestContext: [Circular: *15],
    it: [Circular: *6],
    mock: [Circular: *16],
    run: [Circular: *32],
    suite: [Circular: *11],
...
[Object: null prototype] {
    default: {
        ...
        spec: <ref *5> ƒ spec(length: 0) {},
        [get/set] tap: <ref *6> async ƒ tapReporter(length: 1) {},
        lcov: <ref *7> ƒ lcov(length: 0) {}
    },
    dot: [Circular: *3],
    junit: [Circular: *4],
    lcov: [Circular: *7],
...
[Object: null prototype] {
    default: [Object: null prototype] {
        dot: <ref *3> async ƒ dot(length: 1) {},
        junit: <ref *4> async ƒ junit(length: 1) {},
        lcov: <ref *5> ƒ reporterConstructorWrapper(length: 0) {},
        spec: <ref *6> ƒ reporterConstructorWrapper(length: 0) {},
        tap: <ref *7> async ƒ tap(length: 1) {}
    },
    dot: [Circular: *3],
    junit: [Circular: *4],
    lcov: [Circular: *5],
...
[Object: null prototype] {
    ...
    PerformanceObserver: <ref *3> class PerformanceObserver extends j {},
    PerformanceObserverEntryList: <ref *4> class PerformanceObserverEntryList {},
    constants: <ref *5> {
    ...
    createHistogram: <ref *6> ƒ createHistogram(length: 0) {},
    default: {
        performance: <ref *8> Performance {
            eventLoopUtilization: <ref *9> ƒ eventLoopUtilization(length: 0) {},
            nodeTiming: {},
            timerify: <ref *11> ƒ timerify(length: 1) {},
        ...
        monitorEventLoopDelay: <ref *13> ƒ monitorEventLoopDelay(length: 0) {},
        createHistogram: [Circular: *6],
        eventLoopUtilization: [Circular: *9],
        timerify: [Circular: *11],
        constants: [Circular: *5]
    },
    enqueueNodePerformanceEntry: ƒ enqueueNodePerformanceEntry(length: 1) {},
    eventLoopUtilization: [Circular: *9],
    monitorEventLoopDelay: [Circular: *13],
    performance: [Circular: *8],
    timerify: [Circular: *11]
}
...
[Object: null prototype] {
    ...
    addUncaughtExceptionCaptureCallback: <ref *19> ƒ addUncaughtExceptionCaptureCallback(length: 1) {},
    ...
    arch: "x64",
    argv: <ref *23> [
        "/opt/hostedtoolcache/node/26.8.2/x64/bin/node",
        "/tmp/fs-fixture-1789354379768-2167-1/process.mjs"
    ],
    argv0: "node",
    ...
    default: process {
        ...
        release: <ref *46> {
            name: "node",
            sourceUrl: "https://nodejs.org/download/release/v26.8.2/node-v26.8.2.tar.gz",
            headersUrl: "https://nodejs.org/download/release/v26.8.2/node-v26.8.2-headers.tar.gz"
        },
        ...
        addUncaughtExceptionCaptureCallback: [Circular: *19],
        ...
        env: <ref *116>  {
            GITHUB_STATE: "/home/runner/work/_temp/_runner_file_commands/save_state_73abc0e6-85f7-4b55-9a22-0fc536b93f9b",
            DOTNET_NOLOGO: "1",
            USER: "runner",
            npm_config_user_agent: "pnpm/10.10.0 npm/? node/v26.8.2 linux x64",
            CI: "true",
            USE_BAZEL_FALLBACK_VERSION: "silent:",
            RUNNER_ENVIRONMENT: "github-hosted",
            GITHUB_ENV: "/home/runner/work/_temp/_runner_file_commands/set_env_73abc0e6-85f7-4b55-9a22-0fc536b93f9b",
            PIPX_HOME: "/opt/pipx",
            npm_node_execpath: "/opt/hostedtoolcache/node/26.8.2/x64/bin/node",
            ...
            npm_package_json: "/home/runner/work/compare-deno-node/compare-deno-node/package.json",
            ...
            ACTIONS_ORCHESTRATION_ID: "e5bfd01f-0b2b-4e93-aec0-12962b85abb5.comparison.__default",
            ...
            GITHUB_ARTIFACTS: "/home/runner/work/_temp/_runner_file_commands/artifacts_73abc0e6-85f7-4b55-9a22-0fc536b93f9b",
            SWIFT_PATH: "/usr/share/swift/usr/bin",
            CHROMEWEBDRIVER: "/usr/local/share/chromedriver-linux64",
            JOURNAL_STREAM: "9:9076",
            ...
            GITHUB_RUN_ID: "34800667563",
            GITHUB_REF_TYPE: "branch",
            BOOTSTRAP_HASKELL_NONINTERACTIVE: "1",
            GITHUB_WORKFLOW_SHA: "8aacc10c89e1e058c59224c018852224c1f70905",
            GOROOT_1_26_X64: "/opt/hostedtoolcache/go/1.26.8/x64",
            GITHUB_BASE_REF: "",
            ImageOS: "ubuntu24",
            GITHUB_WORKFLOW_REF: "outslept/compare-deno-node/.github/workflows/compare.yml@refs/heads/main",
            ...
            PATH: "/home/runner/work/compare-deno-node/compare-deno-node/node_modules/.bin:/home/runner/work/compare-de…",
            ANT_HOME: "/usr/share/ant",
            DOTNET_MULTILEVEL_LOOKUP: "0",
            RUNNER_TRACKING_ID: "github_3f3ad2dd-9455-40ae-bf9f-a74705a39850",
            INVOCATION_ID: "1d1d35e18ceb458facebc009a51dfdcc",
            RUNNER_TOOL_CACHE: "/opt/hostedtoolcache",
            npm_package_name: "deno-compare-node",
            NODE: "/opt/hostedtoolcache/node/26.8.2/x64/bin/node",
            ...
            RUNNER_NAME: "GitHub Actions 1000004145",
            XDG_CONFIG_HOME: "/home/runner/.config",
            GITHUB_REF_NAME: "main",
            GITHUB_REPOSITORY: "outslept/compare-deno-node",
            ...
            GITHUB_ACTIONS: "true",
            NODE_PATH: "/home/runner/work/compare-deno-node/compare-deno-node/node_modules/.pnpm/tsx@4.20.3/node_modules/tsx…",
            npm_package_version: "0.0.1",
            npm_lifecycle_event: "start",
            npm_config_verify_deps_before_run: "false",
            GITHUB_REF_PROTECTED: "false",
            GITHUB_WORKSPACE: "/home/runner/work/compare-deno-node/compare-deno-node",
            ACCEPT_EULA: "Y",
            GITHUB_JOB: "comparison",
            GITHUB_SHA: "8aacc10c89e1e058c59224c018852224c1f70905",
            GITHUB_RUN_ATTEMPT: "1",
            ACTIONS_RUNNER_RETURN_JOB_RESULT_FOR_HOSTED: "1",
            GITHUB_REF: "refs/heads/main",
            GITHUB_ACTOR: "outslept",
            ANDROID_SDK_ROOT: "/usr/local/lib/android/sdk",
            GITHUB_PATH: "/home/runner/work/_temp/_runner_file_commands/add_path_73abc0e6-85f7-4b55-9a22-0fc536b93f9b",
            JAVA_HOME: "/usr/lib/jvm/temurin-17-jdk-amd64",
            PWD: "/home/runner/work/compare-deno-node/compare-deno-node",
            GITHUB_ACTOR_ID: "135520429",
            RUNNER_WORKSPACE: "/home/runner/work/compare-deno-node",
            ...
            GITHUB_OUTPUT: "/home/runner/work/_temp/_runner_file_commands/set_output_73abc0e6-85f7-4b55-9a22-0fc536b93f9b",
            EDGEWEBDRIVER: "/usr/local/share/edge_driver",
            npm_config__jsr_registry: "https://npm.jsr.io/",
            npm_command: "run-script",
            PNPM_SCRIPT_SRC_DIR: "/home/runner/work/compare-deno-node/compare-deno-node",
            ANDROID_NDK: "/usr/local/lib/android/sdk/ndk/27.3.13750724",
            GITHUB_ARTIFACTS_LIST: "/home/runner/work/_temp/_runner_file_commands/artifacts_list_73abc0e6-85f7-4b55-9a22-0fc536b93f9b",
            SGX_AESM_ADDR: "1",
            ...
            GITHUB_STEP_SUMMARY: "/home/runner/work/_temp/_runner_file_commands/step_summary_73abc0e6-85f7-4b55-9a22-0fc536b93f9b",
            INIT_CWD: "/home/runner/work/compare-deno-node/compare-deno-node"
        },
        title: "node",
        argv: [Circular: *23],
        execArgv: <ref *117> [],
        pid: 2600,
        ppid: 2167,
        execPath: "/opt/hostedtoolcache/node/26.8.2/x64/bin/node",
        debugPort: 9229,
        argv0: "node",
...
[Object: null prototype] {
    ...
    arch: "x64",
    argv: <ref *6> [
        "/opt/hostedtoolcache/deno/0.0.0-336da420f4343cbb1dcbd5eed9d075ff555ed6ee/x64/deno",
        "/tmp/fs-fixture-1789354379768-2167-1/process.mjs"
    ],
    argv0: "deno",
    availableMemory: <ref *7> ƒ availableMemory(length: 0) {},
    chdir: <ref *8> ƒ chdir(length: 1) {},
    constrainedMemory: <ref *9> ƒ constrainedMemory(length: 0) {},
    cpuUsage: <ref *10> ƒ cpuUsage(length: 1) {},
    cwd: <ref *11> ƒ cwd(length: 0) {},
    default: process {
        _events: [Object: null prototype] {
        ...
        _debugProcess: ƒ _debugProcess(length: 1) {},
        chdir: [Circular: *8],
        cpuUsage: [Circular: *10],
        threadCpuUsage: <ref *19> ƒ threadCpuUsage(length: 1) {},
        cwd: [Circular: *11],
        env: <ref *20> {
            SYSTEMD_EXEC_PID: "1810",
            VCPKG_INSTALLATION_ROOT: "/usr/local/share/vcpkg",
        ...
        execArgv: <ref *21> [],
        exit: <ref *22> ƒ exit(length: 1) {},
        abort: [Circular: *2],
        openStdin: ƒ (length: 0) {},
        _rawDebug: ƒ (length: 0) {},
        getActiveResourcesInfo: <ref *25> ƒ getActiveResourcesInfo(length: 0) {},
        _getActiveRequests: ƒ getActiveRequests(length: 0) {},
        _getActiveHandles: ƒ getActiveHandles(length: 0) {},
        reallyExit: ƒ (length: 1) {},
        _exiting: false,
        setUncaughtExceptionCaptureCallback: ƒ (length: 1) {},
        hasUncaughtExceptionCaptureCallback: ƒ (length: 0) {},
        _fatalException: ƒ (length: 2) {},
        mainModule: undefined,
        nextTick: <ref *32> ƒ nextTick(length: 1) {},
        dlopen: <ref *33> ƒ dlopen(length: 3) {},
        setSourceMapsEnabled: ƒ (length: 1) {},
        [get/set] sourceMapsEnabled: true,
        hrtime: <ref *35> ƒ hrtime(length: 1) {
            bigint: ƒ (length: 0) {}
        },
        _kill: ƒ _kill(length: 2) {},
        kill: <ref *38> ƒ kill(length: 1) {},
        memoryUsage: <ref *39> ƒ memoryUsage(length: 0) {
            rss: ƒ (length: 0) {}
        },
        availableMemory: [Circular: *7],
        constrainedMemory: [Circular: *9],
        resourceUsage: <ref *41> ƒ resourceUsage(length: 0) {},
        [get/set] stderr: <ref *42> Writable {
            _events: {
                close: undefined,
                error: undefined,
                prefinish: undefined,
            ...
            hasColors: ƒ value(length: 2) {},
            Symbol(kCapture): false
        },
        [get/set] stdin: <ref *52> Duplex {
            _events: {
                close: ƒ (length: 0) {},
                error: undefined,
                prefinish: undefined,
            ...
            _handle: {
                ...
                getAsyncId: ƒ getAsyncId(length: 0) {}
            },
            _eventsCount: 2,
            fd: 0,
            [get/set] isTTY: false,
        ...
        [get/set] stdout: <ref *68> Writable {
            _events: {
                close: undefined,
                error: undefined,
                prefinish: undefined,
        ...
        emitWarning: <ref *78> ƒ emitWarning(length: 4) {},
        binding: ƒ (length: 1) {},
        umask: <ref *80> ƒ umask(length: 1) {},
        getgid: <ref *81> ƒ getgid(length: 0) {},
        getuid: <ref *82> ƒ getuid(length: 0) {},
        getgroups: ƒ (length: 0) {},
        getegid: <ref *84> ƒ getegid(length: 0) {},
        geteuid: <ref *85> ƒ geteuid(length: 0) {},
        setegid: <ref *86> ƒ (length: 1) {},
        seteuid: <ref *87> ƒ (length: 1) {},
        setgid: <ref *88> ƒ (length: 1) {},
        setuid: <ref *89> ƒ (length: 1) {},
        [get/set] getBuiltinModule: ƒ getBuiltinModule(length: 1) {},
        _eval: undefined,
        loadEnvFile: <ref *91> ƒ loadEnvFile(length: 0) {},
        uptime: ƒ (length: 0) {},
        features: {
            inspector: true,
            debug: false,
    ...
    dlopen: [Circular: *33],
    emitWarning: [Circular: *78],
    env: [Circular: *20],
    execArgv: [Circular: *21],
    execPath: "/opt/hostedtoolcache/deno/0.0.0-336da420f4343cbb1dcbd5eed9d075ff555ed6ee/x64/deno",
    exit: [Circular: *22],
    getActiveResourcesInfo: [Circular: *25],
    getBuiltinModule: ƒ getBuiltinModule(length: 1) {},
    getegid: [Circular: *84],
    geteuid: [Circular: *85],
    getgid: [Circular: *81],
    ...
    hrtime: [Circular: *35],
    kill: [Circular: *38],
    loadEnvFile: [Circular: *91],
    memoryUsage: [Circular: *39],
    nextTick: [Circular: *32],
    pid: 2602,
    platform: "linux",
    ppid: 2167,
    ...
    stdin: [Circular: *52],
    stdout: [Circular: *68],
    threadCpuUsage: [Circular: *19],
    umask: [Circular: *80],
    version: "v26.5.1",
    versions: [Circular: *77]
}
...
(node:2613) [DEP0040] DeprecationWarning: The `punycode` module is deprecated. Please use a userland alternative instead.
...
[Object: null prototype] {
    ...
    default: {
        ...
        moveCursor: <ref *9> ƒ moveCursor(length: 4) {},
        promises: <ref *10> {
            Interface: class Interface extends i {},
            Readline: class Readline {},
            createInterface: ƒ createInterface(length: 4) {}
        }
    },
...
```js
[Object: null prototype] {
    Interface: <ref *2> class Interface extends i {},
    Readline: <ref *3> class Readline {},
    createInterface: <ref *4> ƒ createInterface(length: 4) {},
    default: {
        Interface: [Circular: *2],
...
```js
[Object: null prototype] {
    REPLServer: <ref *2> class REPLServer extends U {},
    REPL_MODE_SLOPPY: Symbol(repl-sloppy),
    REPL_MODE_STRICT: Symbol(repl-strict),
    Recoverable: <ref *3> class Recoverable extends H {},
    _builtinLibs: <ref *4> [
        "assert",
        "async_hooks",
        "buffer",
    ...
    builtinModules: [Circular: *4],
    default: {
        REPLServer: [Circular: *2],
        builtinModules: [Circular: *4],
        _builtinLibs: [Circular: *4],
        start: <ref *6> ƒ start(length: 6) {},
        writer: ƒ writer(length: 1) {
            options: {
                indentationLvl: 0,
                currentDepth: 0,
                stylize: ƒ stylizeNoColor(length: 1) {},
                showHidden: false,
                depth: 2,
                colors: false,
                showProxy: true,
...
[Object: null prototype] {
    ...
    Stream: <ref *14> ƒ Stream(length: 1) {
        ...
        Writable: <ref *20> ƒ Writable(length: 1) {
            WritableState: ƒ WritableState(length: 3) {},
            kForceStableState: Symbol(kForceStableState),
            fromWeb: ƒ (length: 2) {},
            toWeb: ƒ (length: 1) {}
        },
        Duplex: [Circular: *2],
...
[Object: null prototype] {
    ...
    ReadableStreamTee: <ref *13> ƒ ReadableStreamTee(length: 1) {},
    TextDecoderStream: <ref *14> class TextDecoderStream {},
    TextEncoderStream: <ref *15> class TextEncoderStream {},
    TransformStream: <ref *16> class TransformStream {},
    TransformStreamDefaultController: <ref *17> class TransformStreamDefaultController {},
    WritableStream: <ref *18> class WritableStream {},
    WritableStreamDefaultController: <ref *19> class WritableStreamDefaultController {},
    WritableStreamDefaultWriter: <ref *20> class WritableStreamDefaultWriter {},
    default: {
        ReadableStream: [Circular: *7],
        ReadableStreamTee: [Circular: *13],
        ...
        TransformStream: [Circular: *16],
        TransformStreamDefaultController: [Circular: *17],
        WritableStream: [Circular: *18],
        WritableStreamDefaultWriter: [Circular: *20],
        WritableStreamDefaultController: [Circular: *19],
        ByteLengthQueuingStrategy: [Circular: *2],
        CountQueuingStrategy: [Circular: *4],
        TextEncoderStream: [Circular: *15],
        TextDecoderStream: [Circular: *14],
...
[Object: null prototype] {
    ...
    convertProcessSignalToExitCode: <ref *11> ƒ convertProcessSignalToExitCode(length: 1) {},
    debug: <ref *12> ƒ debuglog(length: 2) {},
    debuglog: [Circular: *12],
    default: {
        _errnoException: [Circular: *6],
        _exceptionWithHostPort: [Circular: *7],
        _extend: [Circular: *8],
        callbackify: [Circular: *10],
        convertProcessSignalToExitCode: [Circular: *11],
        debug: [Circular: *12],
        debuglog: [Circular: *12],
        deprecate: <ref *14> ƒ deprecate(length: 3) {},
        format: <ref *15> ƒ format(length: 0) {},
        styleText: <ref *16> ƒ styleText(length: 3) {},
        formatWithOptions: <ref *17> ƒ formatWithOptions(length: 1) {},
        ...
        isArray: <ref *72> ƒ deprecated(length: 1) {},
        isDeepStrictEqual: <ref *73> ƒ isDeepStrictEqual(length: 3) {},
        promisify: <ref *74> ƒ promisify(length: 1) {
            custom: Symbol(nodejs.util.promisify.custom)
        },
        stripVTControlCharacters: <ref *75> ƒ stripVTControlCharacters(length: 1) {},
        toUSVString: <ref *76> ƒ toUSVString(length: 1) {},
        [get/set] transferableAbortSignal: <ref *77> ƒ transferableAbortSignal(length: 1) {},
        [get/set] transferableAbortController: <ref *78> ƒ transferableAbortController(length: 0) {},
        ...
        parseEnv: <ref *123> ƒ parseEnv(length: 1) {},
        parseArgs: <ref *124> ƒ parseArgs(length: 0) {},
        TextDecoder: [Circular: *4],
        TextEncoder: [Circular: *5],
        MIMEType: [Circular: *3],
        MIMEParams: [Circular: *2],
        diff: <ref *125> ƒ diff(length: 2) {},
        setTraceSigInt: <ref *126> ƒ setTraceSigInt(length: 1) {}
    },
    deprecate: [Circular: *14],
    diff: [Circular: *125],
    format: [Circular: *15],
    formatWithOptions: [Circular: *17],
    ...
    parseArgs: [Circular: *124],
    parseEnv: [Circular: *123],
    promisify: [Circular: *74],
    setTraceSigInt: [Circular: *126],
    stripVTControlCharacters: [Circular: *75],
    styleText: [Circular: *16],
    toUSVString: [Circular: *76],
    transferableAbortController: [Circular: *78],
    transferableAbortSignal: [Circular: *77],
    types: [Circular: *79]
}
(node:2769) [DEP0025] DeprecationWarning: sys is deprecated. Use `node:util` instead.
(Use `node --trace-deprecation ...` to show where the warning was created)
...
[Object: null prototype] {
    ...
    aborted: <ref *7> async ƒ aborted(length: 2) {},
    callbackify: <ref *8> ƒ callbackify(length: 1) {},
    convertProcessSignalToExitCode: <ref *9> ƒ convertProcessSignalToExitCode(length: 1) {},
    debug: <ref *10> ƒ debuglog(length: 2) {},
    debuglog: [Circular: *10],
    default: {
        callbackify: [Circular: *8],
        diff: <ref *12> ƒ diff(length: 2) {},
        debuglog: [Circular: *10],
        debug: [Circular: *10],
        ...
        styleText: <ref *65> ƒ styleText(length: 3) {},
        types: <ref *66> {
            isCryptoKey: ƒ isCryptoKey(length: 1) {},
            isKeyObject: ƒ isKeyObject(length: 1) {},
        ...
        isArray: <ref *109> ƒ isArray(length: 1) {},
        _extend: [Circular: *6],
        inherits: <ref *110> ƒ inherits(length: 2) {},
        TextDecoder: [Circular: *4],
        TextEncoder: [Circular: *5],
        toUSVString: <ref *111> ƒ toUSVString(length: 1) {},
        log: <ref *112> ƒ log(length: 0) {},
        deprecate: <ref *113> ƒ deprecate(length: 3) {},
        aborted: [Circular: *7],
        getCallSites: <ref *114> ƒ getCallSites(length: 0) {},
        parseEnv: <ref *115> ƒ parseEnv(length: 1) {},
        queryObjects: <ref *116> ƒ queryObjects(length: 2) {},
        setTraceSigInt: <ref *117> ƒ setTraceSigInt(length: 1) {},
        transferableAbortController: <ref *118> ƒ transferableAbortController(length: 0) {},
        transferableAbortSignal: <ref *119> ƒ transferableAbortSignal(length: 1) {},
        convertProcessSignalToExitCode: [Circular: *9],
        getSystemErrorMap: <ref *120> ƒ getSystemErrorMap(length: 0) {},
        getSystemErrorMessage: <ref *121> ƒ getSystemErrorMessage(length: 1) {},
        getSystemErrorName: <ref *122> ƒ getSystemErrorName(length: 1) {},
        isDeepStrictEqual: <ref *123> ƒ isDeepStrictEqual(length: 3) {}
    },
    deprecate: [Circular: *113],
    diff: [Circular: *12],
    format: [Circular: *13],
    formatWithOptions: [Circular: *14],
    getCallSites: [Circular: *114],
    getSystemErrorMap: [Circular: *120],
    getSystemErrorMessage: [Circular: *121],
    getSystemErrorName: [Circular: *122],
    inherits: [Circular: *110],
    inspect: [Circular: *15],
    isArray: [Circular: *109],
    isDeepStrictEqual: [Circular: *123],
    log: [Circular: *112],
    parseArgs: [Circular: *62],
    parseEnv: [Circular: *115],
    promisify: [Circular: *63],
    queryObjects: [Circular: *116],
    setTraceSigInt: [Circular: *117],
    stripVTControlCharacters: [Circular: *64],
    styleText: [Circular: *65],
    toUSVString: [Circular: *111],
    transferableAbortController: [Circular: *118],
    transferableAbortSignal: [Circular: *119],
    types: [Circular: *66]
}
...
[Object: null prototype] {
    ...
    default: {
        ...
        setImmediate: <ref *9> ƒ setImmediate(length: 1) {
            [get/set] Symbol(nodejs.util.promisify.custom): <ref *10> ƒ setImmediate(length: 1) {}
        },
        clearImmediate: [Circular: *2],
        promises: <ref *11> {
            setTimeout: [Circular: *7],
        ...
        Symbol(Deno.internal.node.mockTimers): ƒ [Deno.internal.node.mockTimers](length: 1) {}
    },
    promises: [Circular: *11],
    setImmediate: [Circular: *9],
...
[Object: null prototype] {
    ...
    getCertificateCompressionAlgorithms: [Circular: *12],
...
[Object: null prototype] {
    ...
    TLSSocket: <ref *5> ƒ TLSSocket(length: 2) {},
    ...
    createSecureContext: <ref *9> ƒ createSecureContext(length: 0) {},
    createSecurePair: <ref *10> ƒ createSecurePair(length: 0) {},
    createServer: <ref *11> ƒ createServer(length: 2) {},
    default: {
        ...
        CLIENT_RENEG_LIMIT: 3,
        CLIENT_RENEG_WINDOW: 600,
        [get/set] DEFAULT_MAX_VERSION: "TLSv1.3",
        [get/set] DEFAULT_MIN_VERSION: "TLSv1.2",
...
[Object: null prototype] {
    ...
    default: {
        ...
        urlToHttpOptions: <ref *10> ƒ urlToHttpOptions(length: 1) {},
        Url: [Circular: *8],
        parse: <ref *11> ƒ parse(length: 3) {},
        format: <ref *12> ƒ format(length: 2) {},
        resolve: <ref *13> ƒ resolve(length: 2) {},
        resolveObject: <ref *14> ƒ resolveObject(length: 2) {},
        domainToASCII: <ref *15> ƒ domainToASCII(length: 1) {},
        domainToUnicode: <ref *16> ƒ domainToUnicode(length: 1) {},
    ...
    resolve: [Circular: *13],
    resolveObject: [Circular: *14],
    urlToHttpOptions: [Circular: *10]
}
...
[Object: null prototype] {
    default: {
        ...
        isDate: <ref *8> ƒ (length: 0) {},
        isExternal: <ref *9> ƒ (length: 0) {},
        isGeneratorFunction: <ref *10> ƒ (length: 0) {},
        isGeneratorObject: <ref *11> ƒ (length: 0) {},
        isMap: <ref *12> ƒ (length: 0) {},
        isMapIterator: <ref *13> ƒ (length: 0) {},
        isModuleNamespaceObject: <ref *14> ƒ (length: 0) {},
        isNativeError: <ref *15> ƒ (length: 0) {},
        isNumberObject: <ref *16> ƒ (length: 0) {},
        isPromise: <ref *17> ƒ (length: 0) {},
        isProxy: <ref *18> ƒ (length: 0) {},
        isRegExp: <ref *19> ƒ (length: 0) {},
        isSet: <ref *20> ƒ (length: 0) {},
        isSetIterator: <ref *21> ƒ (length: 0) {},
        isSharedArrayBuffer: <ref *22> ƒ (length: 0) {},
        isStringObject: <ref *23> ƒ (length: 0) {},
        isSymbolObject: <ref *24> ƒ (length: 0) {},
        isWeakMap: <ref *25> ƒ (length: 0) {},
        isWeakSet: <ref *26> ƒ (length: 0) {},
        isAnyArrayBuffer: <ref *27> ƒ (length: 0) {},
        isBoxedPrimitive: <ref *28> ƒ (length: 0) {},
        isArrayBufferView: <ref *29> ƒ isView(length: 1) {},
        isDataView: <ref *30> ƒ isDataView(length: 1) {},
    ...
    isAnyArrayBuffer: [Circular: *27],
    isArgumentsObject: [Circular: *3],
    isArrayBuffer: [Circular: *4],
    isArrayBufferView: [Circular: *29],
    ...
    isBoxedPrimitive: [Circular: *28],
    isCryptoKey: [Circular: *45],
    isDataView: [Circular: *30],
    isDate: [Circular: *8],
    isExternal: [Circular: *9],
    isFloat16Array: [Circular: *39],
    isFloat32Array: [Circular: *40],
    isFloat64Array: [Circular: *41],
    isGeneratorFunction: [Circular: *10],
    isGeneratorObject: [Circular: *11],
    isInt16Array: [Circular: *37],
    isInt32Array: [Circular: *38],
    isInt8Array: [Circular: *36],
    isKeyObject: [Circular: *44],
    isMap: [Circular: *12],
    isMapIterator: [Circular: *13],
    isModuleNamespaceObject: [Circular: *14],
    isNativeError: [Circular: *15],
    isNumberObject: [Circular: *16],
    isPromise: [Circular: *17],
    isProxy: [Circular: *18],
    isRegExp: [Circular: *19],
    isSet: [Circular: *20],
    isSetIterator: [Circular: *21],
    isSharedArrayBuffer: [Circular: *22],
    isStringObject: [Circular: *23],
    isSymbolObject: [Circular: *24],
    ...
    isWeakMap: [Circular: *25],
    isWeakSet: [Circular: *26]
}
...
[Object: null prototype] {
    default: {
        isCryptoKey: <ref *3> ƒ isCryptoKey(length: 1) {},
        isKeyObject: <ref *4> ƒ isKeyObject(length: 1) {},
        isArrayBufferView: <ref *5> ƒ isArrayBufferView(length: 1) {},
        isBigInt64Array: <ref *6> ƒ isBigInt64Array(length: 1) {},
        isBigUint64Array: <ref *7> ƒ isBigUint64Array(length: 1) {},
        isFloat16Array: <ref *8> ƒ isFloat16Array(length: 1) {},
        isFloat32Array: <ref *9> ƒ isFloat32Array(length: 1) {},
        isFloat64Array: <ref *10> ƒ isFloat64Array(length: 1) {},
        isInt8Array: <ref *11> ƒ isInt8Array(length: 1) {},
        isInt16Array: <ref *12> ƒ isInt16Array(length: 1) {},
        isInt32Array: <ref *13> ƒ isInt32Array(length: 1) {},
        isUint8Array: <ref *14> ƒ isUint8Array(length: 1) {},
        isUint8ClampedArray: <ref *15> ƒ isUint8ClampedArray(length: 1) {},
        isUint16Array: <ref *16> ƒ isUint16Array(length: 1) {},
        isUint32Array: <ref *17> ƒ isUint32Array(length: 1) {},
        isAnyArrayBuffer: <ref *18> ƒ isAnyArrayBuffer(length: 1) {},
        isArgumentsObject: <ref *19> ƒ isArgumentsObject(length: 1) {},
        isArrayBuffer: <ref *20> ƒ isArrayBuffer(length: 1) {},
        isAsyncFunction: <ref *21> ƒ isAsyncFunction(length: 1) {},
        isBigIntObject: <ref *22> ƒ isBigIntObject(length: 1) {},
        isBooleanObject: <ref *23> ƒ isBooleanObject(length: 1) {},
        isBoxedPrimitive: <ref *24> ƒ isBoxedPrimitive(length: 1) {},
        isDataView: <ref *25> ƒ isDataView(length: 1) {},
        isDate: <ref *26> ƒ isDate(length: 1) {},
        isGeneratorFunction: <ref *27> ƒ isGeneratorFunction(length: 1) {},
        isGeneratorObject: <ref *28> ƒ isGeneratorObject(length: 1) {},
        isMap: <ref *29> ƒ isMap(length: 1) {},
        isMapIterator: <ref *30> ƒ isMapIterator(length: 1) {},
        isModuleNamespaceObject: <ref *31> ƒ isModuleNamespaceObject(length: 1) {},
        isNativeError: <ref *32> ƒ isNativeError(length: 1) {},
        isNumberObject: <ref *33> ƒ isNumberObject(length: 1) {},
        isPromise: <ref *34> ƒ isPromise(length: 1) {},
        isProxy: <ref *35> ƒ isProxy(length: 1) {},
        isRegExp: <ref *36> ƒ isRegExp(length: 1) {},
        isSet: <ref *37> ƒ isSet(length: 1) {},
        isSetIterator: <ref *38> ƒ isSetIterator(length: 1) {},
        isSharedArrayBuffer: <ref *39> ƒ isSharedArrayBuffer(length: 1) {},
        isStringObject: <ref *40> ƒ isStringObject(length: 1) {},
        isSymbolObject: <ref *41> ƒ isSymbolObject(length: 1) {},
        isTypedArray: <ref *42> ƒ isTypedArray(length: 1) {},
        isWeakMap: <ref *43> ƒ isWeakMap(length: 1) {},
        isWeakSet: <ref *44> ƒ isWeakSet(length: 1) {}
    },
    isAnyArrayBuffer: [Circular: *18],
    isArgumentsObject: [Circular: *19],
    isArrayBuffer: [Circular: *20],
    isArrayBufferView: [Circular: *5],
    isAsyncFunction: [Circular: *21],
    isBigInt64Array: [Circular: *6],
    isBigIntObject: [Circular: *22],
    isBigUint64Array: [Circular: *7],
    isBooleanObject: [Circular: *23],
    isBoxedPrimitive: [Circular: *24],
    isCryptoKey: [Circular: *3],
    isDataView: [Circular: *25],
    isDate: [Circular: *26],
    isFloat16Array: [Circular: *8],
    isFloat32Array: [Circular: *9],
    isFloat64Array: [Circular: *10],
    isGeneratorFunction: [Circular: *27],
    isGeneratorObject: [Circular: *28],
    isInt16Array: [Circular: *12],
    isInt32Array: [Circular: *13],
    isInt8Array: [Circular: *11],
    isKeyObject: [Circular: *4],
    isMap: [Circular: *29],
    isMapIterator: [Circular: *30],
    isModuleNamespaceObject: [Circular: *31],
    isNativeError: [Circular: *32],
    isNumberObject: [Circular: *33],
    isPromise: [Circular: *34],
    isProxy: [Circular: *35],
    isRegExp: [Circular: *36],
    isSet: [Circular: *37],
    isSetIterator: [Circular: *38],
    isSharedArrayBuffer: [Circular: *39],
    isStringObject: [Circular: *40],
    isSymbolObject: [Circular: *41],
    isTypedArray: [Circular: *42],
    isUint16Array: [Circular: *16],
    isUint32Array: [Circular: *17],
    isUint8Array: [Circular: *14],
    isUint8ClampedArray: [Circular: *15],
...
[Object: null prototype] {
    ...
    default: {
        ...
        startCpuProfile: <ref *34> ƒ startCpuProfile(length: 1) {},
        startHeapProfile: <ref *35> ƒ startHeapProfile(length: 1) {}
    },
...
[Object: null prototype] {
    ...
    default: {
        cachedDataVersionTag: [Circular: *7],
        getHeapCodeStatistics: <ref *9> ƒ getHeapCodeStatistics(length: 0) {},
        getHeapSnapshot: <ref *10> ƒ getHeapSnapshot(length: 1) {},
        getHeapSpaceStatistics: <ref *11> ƒ getHeapSpaceStatistics(length: 0) {},
        getHeapStatistics: <ref *12> ƒ getHeapStatistics(length: 0) {},
        queryObjects: <ref *13> ƒ queryObjects(length: 1) {},
        setFlagsFromString: <ref *14> ƒ setFlagsFromString(length: 1) {},
        setHeapSnapshotNearHeapLimit: <ref *15> ƒ setHeapSnapshotNearHeapLimit(length: 1) {},
        startupSnapshot: <ref *16> {
            setDeserializeMainFunction: ƒ startupSnapshotSetDeserializeMainFunction(length: 2) {},
            addSerializeCallback: ƒ startupSnapshotAddSerializeCallback(length: 2) {},
            addDeserializeCallback: ƒ startupSnapshotAddDeserializeCallback(length: 2) {},
            isBuildingSnapshot: ƒ startupSnapshotIsBuildingSnapshot(length: 0) {}
        },
        stopCoverage: <ref *21> ƒ stopCoverage(length: 0) {},
        takeCoverage: <ref *22> ƒ takeCoverage(length: 0) {},
        writeHeapSnapshot: <ref *23> ƒ writeHeapSnapshot(length: 2) {},
        serialize: <ref *24> ƒ serialize(length: 1) {},
        deserialize: <ref *25> ƒ deserialize(length: 1) {},
        GCProfiler: [Circular: *5],
        Serializer: [Circular: *6],
        Deserializer: [Circular: *4],
        DefaultSerializer: [Circular: *3],
        DefaultDeserializer: [Circular: *2],
        promiseHooks: {
            onInit: ƒ onInit(length: 1) {},
            onBefore: ƒ onBefore(length: 1) {},
            onAfter: ƒ onAfter(length: 1) {},
            onSettled: ƒ onSettled(length: 1) {},
            createHook: ƒ createHook(length: 1) {}
        }
    },
    deserialize: [Circular: *25],
    getHeapCodeStatistics: [Circular: *9],
    getHeapSnapshot: [Circular: *10],
    getHeapSpaceStatistics: [Circular: *11],
    getHeapStatistics: [Circular: *12],
    queryObjects: [Circular: *13],
    serialize: [Circular: *24],
    setFlagsFromString: [Circular: *14],
    setHeapSnapshotNearHeapLimit: [Circular: *15],
    startupSnapshot: [Circular: *16],
    stopCoverage: [Circular: *21],
    takeCoverage: [Circular: *22],
    writeHeapSnapshot: [Circular: *23]
}
...
[Object: null prototype] {
    ...
    default: {
        ...
        isContext: <ref *14> ƒ isContext(length: 1) {},
        compileFunction: [Circular: *6],
        measureMemory: <ref *15> ƒ measureMemory(length: 1) {}
    },
...
(node:2941) ExperimentalWarning: WASI is an experimental feature and might change at any time
...
```js
[Object: null prototype] {
    BroadcastChannel: <ref *2> class BroadcastChannel extends Pe {},
    MessageChannel: <ref *3> ƒ NodeMessageChannel(length: 0) {},
    MessagePort: <ref *4> ƒ MessagePort(length: 0) {},
    SHARE_ENV: Symbol(nodejs.worker_threads.SHARE_ENV),
    Worker: <ref *5> class NodeWorker extends je {},
    default: {
        BroadcastChannel: [Circular: *2],
        MessagePort: [Circular: *4],
        MessageChannel: [Circular: *3],
        ...
        threadName: "",
        locks: <ref *8> LockManager {
            Symbol([[webidl.brand]]): Symbol([[webidl.brand]])
        },
        markAsUncloneable: <ref *9> ƒ markAsUncloneable(length: 1) {},
        markAsUntransferable: <ref *10> ƒ markAsUntransferable(length: 1) {},
        isMarkedAsUntransferable: <ref *11> ƒ isMarkedAsUntransferable(length: 1) {},
        moveMessagePortToContext: <ref *12> ƒ moveMessagePortToContext(length: 2) {},
        postMessageToThread: <ref *13> ƒ postMessageToThread(length: 4) {},
        receiveMessageOnPort: <ref *14> ƒ receiveMessageOnPort(length: 1) {},
        getEnvironmentData: <ref *15> ƒ getEnvironmentData(length: 1) {},
        setEnvironmentData: <ref *16> ƒ setEnvironmentData(length: 2) {},
        SHARE_ENV: Symbol(nodejs.worker_threads.SHARE_ENV)
    },
    getEnvironmentData: [Circular: *15],
    isInternalThread: false,
    isMainThread: true,
    isMarkedAsUntransferable: [Circular: *11],
    locks: [Circular: *8],
    markAsUncloneable: [Circular: *9],
    markAsUntransferable: [Circular: *10],
    moveMessagePortToContext: [Circular: *12],
    parentPort: null,
    postMessageToThread: [Circular: *13],
    receiveMessageOnPort: [Circular: *14],
    resourceLimits: [Circular: *7],
    setEnvironmentData: [Circular: *16],
    threadId: 0,
    threadName: "",
    workerData: null
}
...
[Object: null prototype] {
    ...
    ZipBuffer: <ref *11> class ExperimentalZipBuffer extends ZipBuffer {},
    ZipEntry: <ref *12> class ExperimentalZipEntry extends ZipEntry {},
    ZipFile: <ref *13> class ExperimentalZipFile extends ZipFile {},
    ZstdCompress: <ref *14> class ZstdCompress extends Zstd {},
    ZstdDecompress: <ref *15> class ZstdDecompress extends Zstd {},
    brotliCompress: <ref *16> ƒ asyncBufferWrapper(length: 3) {},
    brotliCompressSync: <ref *17> ƒ syncBufferWrapper(length: 2) {},
    brotliDecompress: <ref *18> ƒ asyncBufferWrapper(length: 3) {},
    brotliDecompressSync: <ref *19> ƒ syncBufferWrapper(length: 2) {},
    codes: <ref *20> {
        0: "Z_OK",
        1: "Z_STREAM_END",
        2: "Z_NEED_DICT",
    ...
    crc32: <ref *22> ƒ crc32(length: 1) {},
    createBrotliCompress: <ref *23> ƒ createBrotliCompress(length: 1) {},
    createBrotliDecompress: <ref *24> ƒ createBrotliDecompress(length: 1) {},
    createDeflate: <ref *25> ƒ createDeflate(length: 1) {},
    createDeflateRaw: <ref *26> ƒ createDeflateRaw(length: 1) {},
    createGunzip: <ref *27> ƒ createGunzip(length: 1) {},
    createGzip: <ref *28> ƒ createGzip(length: 1) {},
    createInflate: <ref *29> ƒ createInflate(length: 1) {},
    createInflateRaw: <ref *30> ƒ createInflateRaw(length: 1) {},
    createUnzip: <ref *31> ƒ createUnzip(length: 1) {},
    createZipArchive: <ref *32> ƒ (length: 0) {},
    createZipArchiveSync: <ref *33> ƒ (length: 0) {},
    createZstdCompress: <ref *34> ƒ createZstdCompress(length: 1) {},
    createZstdDecompress: <ref *35> ƒ createZstdDecompress(length: 1) {},
    default: {
        crc32: [Circular: *22],
        Deflate: [Circular: *4],
        Inflate: [Circular: *8],
        ...
        ZstdCompress: [Circular: *14],
        ZstdDecompress: [Circular: *15],
        deflate: <ref *37> ƒ asyncBufferWrapper(length: 3) {},
        deflateSync: <ref *38> ƒ syncBufferWrapper(length: 2) {},
        gzip: <ref *39> ƒ asyncBufferWrapper(length: 3) {},
        gzipSync: <ref *40> ƒ syncBufferWrapper(length: 2) {},
        deflateRaw: <ref *41> ƒ asyncBufferWrapper(length: 3) {},
        deflateRawSync: <ref *42> ƒ syncBufferWrapper(length: 2) {},
        unzip: <ref *43> ƒ asyncBufferWrapper(length: 3) {},
        unzipSync: <ref *44> ƒ syncBufferWrapper(length: 2) {},
        inflate: <ref *45> ƒ asyncBufferWrapper(length: 3) {},
        inflateSync: <ref *46> ƒ syncBufferWrapper(length: 2) {},
        gunzip: <ref *47> ƒ asyncBufferWrapper(length: 3) {},
        gunzipSync: <ref *48> ƒ syncBufferWrapper(length: 2) {},
        inflateRaw: <ref *49> ƒ asyncBufferWrapper(length: 3) {},
        inflateRawSync: <ref *50> ƒ syncBufferWrapper(length: 2) {},
        brotliCompress: [Circular: *16],
        brotliCompressSync: [Circular: *17],
        brotliDecompress: [Circular: *18],
        brotliDecompressSync: [Circular: *19],
        zstdCompress: <ref *51> ƒ asyncBufferWrapper(length: 3) {},
        zstdCompressSync: <ref *52> ƒ syncBufferWrapper(length: 2) {},
        zstdDecompress: <ref *53> ƒ asyncBufferWrapper(length: 3) {},
        zstdDecompressSync: <ref *54> ƒ syncBufferWrapper(length: 2) {},
        createDeflate: [Circular: *25],
        createInflate: [Circular: *29],
        createDeflateRaw: [Circular: *26],
        createInflateRaw: [Circular: *30],
        createGzip: [Circular: *28],
        createGunzip: [Circular: *27],
        createUnzip: [Circular: *31],
        createBrotliCompress: [Circular: *23],
        createBrotliDecompress: [Circular: *24],
        createZstdCompress: [Circular: *34],
        createZstdDecompress: [Circular: *35],
        constants: [Circular: *21],
        codes: [Circular: *20],
        ZipEntry: [Circular: *12],
        ZipFile: [Circular: *13],
        ZipBuffer: [Circular: *11],
        createZipArchive: [Circular: *32],
        createZipArchiveSync: [Circular: *33],
        zipFiles: <ref *55> ƒ (length: 0) {},
        getMaxZipContentSize: <ref *56> ƒ (length: 0) {},
        setMaxZipContentSize: <ref *57> ƒ (length: 0) {}
    },
    deflate: [Circular: *37],
    deflateRaw: [Circular: *41],
    deflateRawSync: [Circular: *42],
    deflateSync: [Circular: *38],
    getMaxZipContentSize: [Circular: *56],
    gunzip: [Circular: *47],
    ...
    setMaxZipContentSize: [Circular: *57],
    unzip: [Circular: *43],
    unzipSync: [Circular: *44],
    zipFiles: [Circular: *55],
    zstdCompress: [Circular: *51],
    zstdCompressSync: [Circular: *52],
    zstdDecompress: [Circular: *53],
    zstdDecompressSync: [Circular: *54]
}
